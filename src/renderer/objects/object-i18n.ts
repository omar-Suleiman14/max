...
const copy = {
  en: {
    ...
    emptyBody: 'Create the first record or configure properties for the way this workspace works.',
    ...
    noPropertiesBody: 'The display name works now. Add only the fields this workspace actually needs.',
    optional: 'Optional',
    ...
    required: 'Required',
    semanticRole: 'Workspace behavior',
    semanticRoleDisplay: 'Display name',
    semanticRoleNone: 'No special behavior',
    semanticRolePrice: 'Selling price',
    semanticRoleQuantity: 'Inventory quantity',
    save: 'Save',
    schema: 'Schema',
    schemaSummary: 'Configuration is stored as data, never hardcoded fields.',
    type: 'Type',
    unique: 'Unique',
  ...
  ar: {
    ...
    required: 'مطلوب',
    semanticRole: 'وظيفة الحقل',
    semanticRoleDisplay: 'اسم العرض',
    semanticRoleNone: 'حقل عادي',
    semanticRolePrice: 'سعر البيع',
    semanticRoleQuantity: 'كمية المخزون',
    save: 'حفظ',
    schema: 'إعداد قاعدة البيانات',
    schemaSummary: 'أضف الحقول التي تحتاجها، ورتّب بيانات مساحة عملك بطريقتك.',
    type: 'النوع',
    unique: 'فريد',
