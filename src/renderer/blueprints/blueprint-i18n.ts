...
const copy = {
  en: {
    ...
    blueprintTitle: 'Shop Blueprints',
    cancel: 'Cancel',
    close: 'Close',
    ...
    exportSubtitle: 'Export your schema, property configurations, and templates into a portable JSON blueprint.',
    importBlueprint: 'Import Blueprint',
    importConfirm: 'Import and Apply',
    importError: 'Could not import blueprint.',
    importSubtitle: 'Import an existing blueprint to add or update properties and templates.',
